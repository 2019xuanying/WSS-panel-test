...
# V5.5.14 (Axiom Refactor - SSHD Config Stronger Allow)
#
# [AXIOM V5.5.14 CHANGELOG]
# - 强化主 SSHD 配置：确保 Match Address 127.0.0.1 块内包含 AllowTcpForwarding yes，
#   以保证 WSS 隧道内的 UDP-over-TCP 转发到 UDPGW 端口（7300）的权限。
...
# [AXIOM V5.5.14 FIX] 移除所有 Port 定义，确保 WSS_TUNNEL_BLOCK 可以捕获到所有连接
...
Match Address 127.0.0.1,::1
    # [AXIOM V5.5.14 FIX] 强制允许 TCP 转发，这是 SSH UDP 隧道的前提
...
echo "=================================================="
echo "✅ 部署完成！(Axiom V5.5.14 - Final SSHD Fix)"
echo "=================================================="
